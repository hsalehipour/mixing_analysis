...
% Later found to be mis-leading and not neccessary (I added it for low Ri
% cases to get rid of really large Reb, but they are good to have.
% for ii=1:ntime;
%     if(KE3d(ii)<KE2d(ii)); 
%         indtfo=ii+1;     
%     end;
