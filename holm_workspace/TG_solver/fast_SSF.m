function [sig]=fast_SSF(z,U,rho,k,l,nu,kappa,iBC1,iBCN,imode,J)
%
...
% U = velocity profile
% rho = density profile (negative of the bouyancy profile)
% k,l = wave vector 
% k = x-wavenumber (direction of mean flow U), l = y-wavenumber
% nu, kappa = viscosity, diffusivity
% nu = 1/Reynolds, kappa = 1/Peclet = 1/(Reynolds*Prandtl) = 1/(Reynolds*Schmidt)
% J = bulk Richardson number
